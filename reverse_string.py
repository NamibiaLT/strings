'''
Write a function reverse_words() that takes
a message as a list of characters and
...
def reverse_words(message):
    ...
    #hold the index of the *start* of current word
    # as you look for the *end* of the current word
